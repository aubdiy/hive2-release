...
public class OrcInputFormat implements InputFormat<NullWritable, OrcStruct>,
  ...
  static List<OrcSplit> generateSplitsInfo(Configuration conf, Context context)
    ...
    try {
      ...
      while (resultsLeft > 0) {
        ...
        boolean isDefaultFs = (!checkDefaultFs) || ((adi.fs instanceof DistributedFileSystem)
            && HdfsUtils.isDefaultFs((DistributedFileSystem) adi.fs));
  ...
  public RowReader<OrcStruct> getReader(InputSplit inputSplit,
    ...
    setSearchArgument(readOptions, schemaTypes, conf, true);
